...
const sampleUsers: TwitterUser[] = [
  {
    ...
    description:
      "The Real X API. Tweets about API changes, service issues and our Developer Platform.",
    protected: false,
    verified: true,
  ...
  },
  {
    ...
    profile_banner_url:
      "https://pbs.twimg.com/profile_banners/783214/1675101807",
  },
  {
    id: 11348282,
    id_str: "11348282",
    ...
    profile_banner_url:
      "https://pbs.twimg.com/profile_banners/11348282/1690158342",
  },
];
...
const generateRandomTweet = (
  ...
  if (text.includes("http")) {
    ...
    const urlEndIndex =
      text.indexOf(" ", urlStartIndex) > -1
        ? text.indexOf(" ", urlStartIndex)
        : text.length;
...
class TwitterWebSocketService extends EventEmitter {
  ...
  connect() {
    ...
    setTimeout(() => {
      this.emit("status", {
        type: "info",
        message: "Connection established to X stream",
      });
    }, 1000);
  }
  ...
  disconnect() {
    ...
    this.emit("status", {
      type: "info",
      message: "Disconnected from X stream",
    });
  }
