...
import EmptyTokensState from "./components/EmptyTokensState";
    ...
    return (
      <div className="flex-1 min-w-0">
        ...
        {filteredTokens.length === 0 && !loading && (
          <EmptyTokensState message="No tokens found matching your search criteria." />
        )}
      </div>
    );
  };
            ...
            <>
              ...
              {!searchQuery.trim() &&
                ...
                highCapTokens.length === 0 && (
                  <EmptyTokensState message="Tokens will appear here once they're available." />
                )}
            </>
          )}
        </div>
